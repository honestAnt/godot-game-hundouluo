...
func _handle_input(player_velocity):
	# 水平移动
	...
	player_velocity.x = move_direction * speed
	...
	if is_climbing:
		...
		player_velocity.y = climb_direction * climb_speed
...
func die():
	...
	if has_node("/root/GameManager"):
		get_node("/root/GameManager").player_death.emit()
